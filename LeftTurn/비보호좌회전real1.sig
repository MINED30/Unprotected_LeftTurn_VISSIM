...
<sc version="201801" id="1" name="비보호좌회전" frequency="1" steps="0" defaultIntergreenMatrix="0" interstagesUsingMinDurations="true" checkSum="2998459442">
  <signaldisplays>
  ...
  <sgs>
    <sg id="1" name="남북" defaultSignalSequence="7">
      <defaultDurations>
    ...
    <sg id="2" name="서" defaultSignalSequence="7">
      <defaultDurations>
        <defaultDuration display="1" duration="1000" />
        <defaultDuration display="3" duration="5000" />
        <defaultDuration display="4" duration="3000" />
    ...
    <sg id="3" name="동" defaultSignalSequence="7">
      <defaultDurations>
        <defaultDuration display="1" duration="1000" />
        <defaultDuration display="3" duration="5000" />
        <defaultDuration display="4" duration="3000" />
  ...
  <intergreenmatrices />
  <progs>
    <prog id="1" cycletime="140000" switchpoint="0" offset="0" intergreens="0" fitness="0.000000" vehicleCount="0" name="Signal program 1">
      <sgs>
